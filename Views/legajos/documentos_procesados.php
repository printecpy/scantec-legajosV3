        ...
        <div class="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Base de facturación por páginas procesadas de legajos, sin contar la carátula del PDF final.</p>
                </div>

                <div class="flex items-center gap-2">
                    <a target="_blank" href="<?php echo base_url(); ?>legajos/documentos_procesadosPdf?<?php echo htmlspecialchars($queryExport, ENT_QUOTES, 'UTF-8'); ?>" title="Exportar a PDF"
                    ...
                    <a target="_blank" href="<?php echo base_url(); ?>legajos/documentos_procesadosExcel?<?php echo htmlspecialchars($queryExport, ENT_QUOTES, 'UTF-8'); ?>" title="Exportar a Excel"
            ...
            <form method="get" action="<?php echo base_url(); ?>legajos/documentos_procesados" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    ...
                    <div class="md:col-span-2 flex gap-2">
                        ...
                        <a href="<?php echo base_url(); ?>legajos/documentos_procesados"
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="3" class="px-6 py-12 text-center text-gray-400 font-medium">
                                        No hay legajos facturables en el período seleccionado.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h3 class="text-sm font-bold text-gray-800 uppercase tracking-wider">Detalle de documentos procesados</h3>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="9" class="px-6 py-12 text-center text-gray-400 font-medium">
                                        No se encontraron documentos procesados para el filtro indicado.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
