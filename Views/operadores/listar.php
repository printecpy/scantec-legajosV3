            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button title="Registrar" class="btn-icon btn-icon-new" type="button" data-toggle="modal"
                        data-target="#nuevoOpe"><i class="fas fa-plus-circle"></i></button>
                    <a target="_blank" href="<?php echo base_url(); ?>operadores/pdf" title="Generar informe en pdf"
                        class="btn-icon btn-icon-pdf"><i class="fas fa-file-pdf"></i></a>
                    <a target="_blank" href="<?php echo base_url(); ?>operadores/excel" title="Generar informe en excel"
                        class="btn-icon btn-icon-excel"><i class="fas fa-file-excel"></i></a>
                    <a href="<?php echo base_url(); ?>operadores/estacion_trabajo"
                        title="Rgistrar datos de estacion de trabajo" class="btn-icon btn-icon-new">Estacion de
                        trabajo</a>
                    <a href="<?php echo base_url(); ?>operadores/escaner" title="Registrar datos del escaner"
                        class="btn-icon btn-icon-new">Escaner</a>
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td style="font-size: 9px;"><?php echo $operador['nombre']; ?></td>
                                    <td style="font-size: 9px;"><?php echo $operador['apellido']; ?></td>
                                    <td style="font-size: 9px;"><?php echo $operador['direccion']; ?></td>
                                    <td style="font-size: 9px;"><?php echo $operador['proyecto']; ?></td>
                                    <td>
                                        ...
                                        <?php } else { ?>
                                        <form method="post" action="<?php echo base_url(); ?>operadores/reingresar"
