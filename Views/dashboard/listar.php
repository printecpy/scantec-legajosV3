        ...
        <?php if ($_SESSION['id_rol'] == 1): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div
                    ...
                    <h3 class="text-3xl font-montserrat font-bold text-scantec-blue">
                        <?php echo number_format($data['pagina_procesada']['pagina_procesadas'] ?? 0, 0, ',', '.'); ?>
                    </h3>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['Fecha', 'Total Archivos', { role: 'style' }, { role: 'tooltip', p: { html: true } }],
            ...
            var options = {
                ...
                tooltip: { isHtml: true },
                hAxis: { textStyle: { color: '#878787', fontSize: 10 } },
                vAxis: { gridlines: { color: '#f3f4f6' }, textStyle: { color: '#878787' } },
