...
$nombre="Expedientes originales_".$fecha."_(".$hora."_hrs).zip";
...
if($zip->open("../../../Backup originales/".$nombre, \ZipArchive::CREATE | \ZipArchive::OVERWRITE)){
      echo 'error abriendo zip';
}

//indicamos cual es la carpeta que se quiere comprimir
$origen = realpath('C:/Expedientes controlados/');
