                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center text-xs text-gray-500">
                                <?php echo $mostrar_registros['ubicacion']; ?></td>
                            <td class="px-4 py-3 text-center text-xs text-gray-500">
                                <?php echo $mostrar_registros['fecha_indexado']; ?></td>
                            <td class="px-4 py-3 text-center text-xs font-mono text-gray-500">
                                <?php echo $mostrar_registros['version']; ?></td>
...
<div id="metadatosModal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity backdrop-blur-sm" onclick="toggleModal('metadatosModal')"></div>
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all sm:my-8 w-full max-w-2xl border border-gray-100">
                ...
                <div class="bg-scantec-blue px-6 py-4 flex justify-between items-center">
                    ...
                    <button type="button" onclick="toggleModal('metadatosModal')" class="text-white hover:text-gray-200 focus:outline-none">
...
<div id="pdfModal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="fixed inset-0 bg-gray-900 bg-opacity-90 transition-opacity backdrop-blur-md" onclick="toggleModal('pdfModal')"></div>

    <div class="fixed inset-0 z-10 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-2 text-center sm:p-0">
            <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all w-full max-w-7xl h-[90vh] flex flex-col border border-gray-600">
                ...
                <div class="bg-gray-900 px-4 py-3 flex justify-between items-center shrink-0">
                    ...
                    <div class="flex gap-3">
                        <button type="button" onclick="toggleModal('pdfModal')" class="text-gray-400 hover:text-white transition-colors">
