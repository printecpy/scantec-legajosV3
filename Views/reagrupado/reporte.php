            ...
            <div class="row">
                <div class="col-lg-10 m-auto">
                    <div class="card-header">
                        <h4 class="title text-center">Reporte reagrupado de expedientes</h4>
                    </div>
                    <a class="btn-icon btn-icon-volver" title="Volver" href="#"
                        onclick="window.history.back(); return false;"><i class="fas fa-arrow-left"></i></a>
                    <form method="post" action="<?php echo base_url();?>reagrupado/pdf_filtroFecha" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="card-header">
                                <h5 class="titled">Por fecha</h5>
                            </div>
                            <div class="row">
                    ...
                    <form method="post" action="<?php echo base_url();?>reagrupado/excel_filtroFecha" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-2 lg-2 m-1">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>reagrupado/pdf_filtroTotal" target="_blank"
                    ...
                    <form method="post" action="<?php echo base_url(); ?>reagrupado/excel_filtroTotal" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-2 lg-2 m-1">
                    ...
                    <form method="post" action="<?php echo base_url();?>reagrupado/pdf_filtroOperador" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="card-header">
                    ...
                    <form method="post" action="<?php echo base_url();?>reagrupado/excel_filtroOperador" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-3 lg-1 m-2">
