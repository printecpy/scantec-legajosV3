            ...
            <div class="row">
                <div class="col-lg-10 m-auto">
                    <div class="card-header">
                        <h4 class="title text-black text-center">Reporte control de expedientes</h4>
                    </div>
                    <a href="<?php echo base_url(); ?>control" class="btn-icon btn-icon-volver mt-2" title="Volver">
                        <i class="fas fa-arrow-left"></i></a>
                    <form method="post" action="<?php echo base_url();?>control/pdf_filtroFecha" target="_blank"
                        autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input id="desde" class="form-control" type="date" name="desde"
                                                placeholder="Fecha" value="<?php echo date("Y-m-d"); ?>">
                                        </div>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <form method="post" action="<?php echo base_url();?>control/excel_filtroFecha" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-2 lg-2 m-1">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>control/pdf_filtroTotal" target="_blank"
                    ...
                    <form method="post" action="<?php echo base_url(); ?>control/excel_filtroTotal" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-2 lg-2 m-1">
                    ...
                    <form method="post" action="<?php echo base_url();?>control/pdf_filtroOperador" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="card-header">
                                <h5 class="title">Operador</h5>
                            </div>
                            <div class="row">
                    ...
                    <form method="post" action="<?php echo base_url();?>control/excel_filtroOperador" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-3 lg-1 m-2">
                    ...
                    <form method="post" action="<?php echo base_url();?>control/pdf_filtroPC" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="card-header">
                    ...
                    <form method="post" action="<?php echo base_url();?>control/excel_filtroPC" target="_blank"
                        autocomplete="off">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-2 lg-1 m-2">
