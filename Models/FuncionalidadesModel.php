...
class FuncionalidadesModel extends Mysql
{
    ...
    public static function getItemsAgrupacionDisponibles(): array
    {
        return [
            ...
            'gestion_usuarios' => ['etiqueta' => 'Gesti?n de usuarios', 'ruta' => 'usuarios/listar', 'modulo' => 'sistema'],
            ...
            'fallos_sesion' => ['etiqueta' => 'Fallos de sesi?n', 'ruta' => 'logs/registro_session_fail', 'modulo' => 'sistema'],
            'sesiones' => ['etiqueta' => 'Sesiones', 'ruta' => 'logs/registro_sesiones', 'modulo' => 'sistema'],
            'funcionalidades' => ['etiqueta' => 'Gesti?n de m?dulos', 'ruta' => 'funcionalidades/listar', 'modulo' => 'sistema'],
    ...
    public static function getAccesosDisponibles(): array
    {
        return [
            ...
            'empresa' => [
                ...
                'descripcion' => 'Permite gestionar la configuraci?n general de la empresa y sus departamentos.',
                'grupo' => 'Administraci?n',
            ...
            'fallos_sesion' => [
                'etiqueta' => 'Fallos de sesi?n',
                'ruta' => 'logs/registro_session_fail',
                'descripcion' => 'Muestra los fallos de inicio de sesi?n.',
                'grupo' => 'Auditor?a',
            ...
            'funcionalidades_accesos' => [
                'etiqueta' => 'Accesos por rol y departamento',
                'ruta' => 'funcionalidades/accesos',
                'descripcion' => 'Permite configurar el acceso a Funcionalidades seg?n rol y departamento.',
                'grupo' => 'Funcionalidades',
                'rutas' => ['funcionalidades/accesos*', 'funcionalidades/guardar_accesos*'],
            ],
        ];
    ...
    public static function getSeccionesDisponibles(): array
    {
        return [
            ...
            'legajos' => [
                'etiqueta' => 'Legajos',
                'descripcion' => 'Abarca armado, b?squeda, verificaci?n, administraci?n y PDF final.',
    ...
    public static function obtenerRutaRedireccionSegura(int $idRol = 0, int $idDepartamento = 0): string
    {
        $prioridades = [
            ...
            ['seccion' => 'archivos', 'item' => 'buscador_archivos', 'ruta' => 'expedientes/indice_b?squeda'],
